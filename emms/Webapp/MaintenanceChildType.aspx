<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MaintenanceChildType.aspx.cs" Inherits="MaintenanceChildType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Maintenance type</h3>
                        </div>
                        <div class="action">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TenKieuBaoDuong" HeaderStyle-Width="30%" HeaderStyle-CssClass=""
                                ...
                                <asp:TemplateField SortExpression="TenLoaiBaoDuong" HeaderStyle-Width="30%" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Tên loại bảo dưỡng</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("TenLoaiBaoDuong") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="SoLuongBaoDuongDinhKy" HeaderStyle-Width="200px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Hạn bảo dưỡng (tháng/giờ/km)</HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSoLuongBaoDuongDinhKy" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "MaintenanceChildTypeDetail.aspx";
        }
