<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FuelQuotaDetail.aspx.cs" Inherits="FuelQuotaDetail" %>
                    ...
                    <div class="card-header">
                        ...
                        <div class="action">
                            <button type="button" class="btn btn-light" onclick="ReturnPageList()">
                                <i class="material-icons">list</i> Fuel quota list</button>
                        </div>
                        <div class="card-body" id="formatControl" runat="server">
                            <dl class="datalist">
                                ...
                                <dt>Số lượng định mức <span style="color: red">(*)</span></dt>
                                <dd>
                                    <asp:TextBox ID="txtSoLuongDinhMuc" runat="server" class="form-input tiny weight" type="weight"/>
                                    <asp:Label ID="lblDonViDinhMuc" runat="server" Font-Bold="true" />
                                </dd>
