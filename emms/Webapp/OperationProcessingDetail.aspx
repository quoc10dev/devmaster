<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OperationProcessingDetail.aspx.cs" Inherits="OperationProcessingDetail" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="card-header">
                        ...
                        <div class="action">
                            <button type="button" class="btn btn-light" onclick="ReturnPageList()">
                                <i class="material-icons">list</i> Operation processing list</button>
                        </div>
                        <div class="card-body" id="formatControl" runat="server">
                            <dl class="datalist">
                                ...
                                <dt>Ngày hoạt động <span style="color: red">(*)</span></dt>
                                <dd>
                                    <asp:TextBox ID="txtNgayHoatDong" runat="server" CssClass="form-input date" name ="date" />
                                </dd>
                                ...
                                <dt><asp:Label ID="lblDonViGhiNhanHoatDong" runat="server" /> <span style="color: red">(*)</span></dt>
                                <dd>
            ...
            <script type="text/javascript">
                function ReturnPageList() {
                    location.href = "OperationProcessing.aspx";
                }
            </script>
        </ContentTemplate>
    </asp:UpdatePanel>
