...
public partial class EquipmentGroupList : BaseAdminGridPage
{
    #region begin
    ...
    {
        btnAddNew.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.EquipmentGroup_Add); //Phân quyền thêm
    }
    ...
    public override void BindData()
    {
        ...
        DataTable dt = EquipmentGroupManager.SearchEquipmentGroup(txtFilterName.Text.Trim(), PageIndex, PageSize, SortExpression, GetSortOrder, out totalRecord);
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (row != null)
                {
                    ...
                    if (lnkEdit != null)
                    {
                        ...
                        lnkEdit.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.EquipmentGroup_Edit) ||
                            FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.EquipmentGroup_View); //phân quyền sửa, xem chi tiết
                    }
                    ...
                    if (lnkDelete != null)
                    {
                        ...
                        lnkDelete.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.EquipmentGroup_Delete); //phân quyền xóa
                    }
                    ...
                    if (hfName != null && row["TenNhom"] != DBNull.Value)
                        hfName.Value = row["TenNhom"].ToString();
                }
            }
        }
        catch (Exception exc)
    ...
    protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                Response.Redirect(string.Format("EquipmentGroupDetail.aspx?ID={0}", id));
            }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            EquipmentGroupManager.DeleteEquipmentGroup(id);
            HideModal();
            BindData();
        }
        catch (Exception exc)
