<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FrequencyWorking.aspx.cs" Inherits="FrequencyWorking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Frequency working</h3>
                        </div>
                        <div class="action">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="LoạiTrangThietBi" HeaderStyle-Width="200px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="TrangThietBi" HeaderStyle-Width="200px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="SoLuongTanSuat" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>Tần suất hoạt động</HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSoLuongTanSuat" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="NgayBatDauApDung" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>Ngày bắt đầu áp dụng</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# string.Format("{0: dd/MM/yyyy}", Eval("NgayBatDauApDung")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-CssClass="text-right" HeaderStyle-Width="90px"
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "FrequencyWorkingDetail.aspx";
        }
    </script>
</asp:Content>
