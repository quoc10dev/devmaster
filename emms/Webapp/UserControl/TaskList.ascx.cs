...
public partial class UserControl_TaskList : System.Web.UI.UserControl
{
    ...
    protected void dlCapBaoDuong_SelectedIndexChanged(object sender, EventArgs e)
    {
        GetTaskList();
        UpdatePanel2.Update();
        ScriptManager.RegisterStartupScript(UpdatePanel2, UpdatePanel2.GetType(), "Pop", "openModal();", true);
    }
