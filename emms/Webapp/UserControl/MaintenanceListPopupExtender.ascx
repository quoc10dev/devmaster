<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MaintenanceListPopupExtender.ascx.cs" Inherits="UserControl_MaintenanceListPopupExtender" %>
    ...
    <ContentTemplate>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 500px; overflow: auto;" id="PopupMaintenanceList" clientidmode="static" runat="server">
                ...
                <div class="modal-footer">
                    ...
                    <%--<button type="button" class="btn btn-secondary" OnClick="$('#ContentPlaceHolder1_Panel1').hide()">Close JS</button>--%>
...
<script type="text/javascript">
    ...
    function ClosePopupMaintenance() {
        //var mpu = parent.document.getElementById("modalPopupExt"); //$find('ContentPlaceHolder1_Panel1');
        //var mpu = window.parent.document.getElementById("#modalPopupExt");
        //mpu.hide();
