<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TaskList.ascx.cs" Inherits="UserControl_TaskList" %>
<asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div class="modal fade" id="modalSelectTaskDialog" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">Hạng mục: </div>
                            <div class="col-md-8"><asp:Label ID="lblMaintennanceName" runat="server" Text="Test" /></div>
                            <div class="col-md-4">Cấp bảo dưỡng <span style="color: red">(*)</span>:</div>
                            <div class="col-md-8"><asp:DropDownList ID="dlCapBaoDuong" runat="server" CssClass="form-input select2" AutoPostBack="true"
                                OnSelectedIndexChanged="dlCapBaoDuong_SelectedIndexChanged"/></div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnSelect" runat="server" CssClass="btn btn-info" OnClick="btnSelect_Click" Text="Select" OnClientClick="ClosePopup()" />
