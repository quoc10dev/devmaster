<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EquipmentGroupList.aspx.cs" Inherits="EquipmentGroupList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Equipment group</h3>
                        </div>
                        <div class="action">
                        ...
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TenNhom" HeaderStyle-Width="250px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Group name (Vi)</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("TenNhom") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField SortExpression="TenNhomEng" HeaderStyle-Width="250px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Group name (Eng)</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("TenNhomEng") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="GhiChu" HeaderStyle-Width="150px" HeaderStyle-CssClass="col"
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="text-right" HeaderStyle-Width="150px"
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "EquipmentGroupDetail.aspx";
        }
    </script>
</asp:Content>
