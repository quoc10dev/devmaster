<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportActivityHistory.aspx.cs"
    Inherits="ReportActivityHistory" EnableEventValidation="false" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Activity history report</h3>
                        </div>
    ...
    <script type="text/javascript">
       ...
       <%-- //Highlight row when click on Gridview
        window.onload = function () {
            HighlightRow('#<%= this.gridView.ClientID %>');
        }--%>
