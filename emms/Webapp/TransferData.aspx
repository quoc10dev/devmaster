<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransferData.aspx.cs"
    Inherits="TransferData" EnableEventValidation="false" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Get data from GPS</h3>
                        </div>
                        <div class="filter" style="margin-top: 20px">
                            ...
                            <div class="form-inline" id="div1" runat="server" style="display:none">
                                <div class="filter-item">
                                    Công ty
                            ...
                            <div class="form-inline" id="div2" runat="server">
                                <div class="filter-item">
                                ...
                                <div class="filter-item">
                                    <asp:Button ID="btnTransfer" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnTransfer_Click" Text="Transfer" />
                                </div>
                            </div>
                        </div>
                    </div>
