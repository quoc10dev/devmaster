...
public partial class OperationProcessing : BaseAdminGridPage
{
    #region begin
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "SetFormatControls", "Control.Build(" + divFilter.ClientID + ")", true);
        }
        catch (Exception exc)
        {
    ...
    {
        btnAddNew.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.OperationProcessing_Add); //Phân quyền thêm
    }
    ...
    public override void BindData()
    {
        ...
        DataTable dt = OperationProcessingManager.SearchOperationProcessing(tuNgay, denNgay, idCongTy, idNhomTrangThietBi, idLoaiTrangThietBi, 
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (row != null)
                {
                    ...
                    if (lnkEdit != null)
                    {
                        ...
                        lnkEdit.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.OperationProcessing_Edit); //phân quyền sửa
                    }
                    ...
                    if (lnkDelete != null)
                    {
                        ...
                        lnkDelete.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.OperationProcessing_Delete); //phân quyền xóa
                    }
    ...
    protected void gridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                Response.Redirect(string.Format("OperationProcessingDetail.aspx?ID={0}", id));
            }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            OperationProcessingManager.DeleteOperationProcessing(int.Parse(hfIdToDelete.Value));
            HideModal();
            BindData();
        }
        catch (Exception exc)
