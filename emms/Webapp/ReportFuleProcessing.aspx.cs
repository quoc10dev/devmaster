...
public partial class ReportFuleProcessing : BaseAdminGridPage
{
    ...
    public override string FunctionPageCode
    {
        get
        {
            return FunctionCode.Report_Fule_Processing;
        }
    }
    ...
    public override void BindData()
    {
        ...
        //denNgay = tuNgay.AddDays(30); //chỉ cho tìm kiếm trong phạm vi 1 tuần
