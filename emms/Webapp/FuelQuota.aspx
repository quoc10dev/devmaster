<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FuelQuota.aspx.cs" Inherits="FuelQuota" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Fule quota</h3>
                        </div>
                        <div class="action">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TenNhom" HeaderStyle-Width="150px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="LoạiTrangThietBi" HeaderStyle-Width="150px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="SoLuongDinhMuc" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>SL định mức</HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSoLuongDinhMuc" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="text-right" HeaderStyle-Width="100px"
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "FuelQuotaDetail.aspx";
        }
    </script>
</asp:Content>
