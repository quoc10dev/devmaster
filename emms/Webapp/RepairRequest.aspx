<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RepairRequest.aspx.cs" Inherits="RepairRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Repair & Overcom Problem Request</h3>
                        </div>
                        <div class="action">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="NgayBaoDuong" HeaderStyle-Width="90px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="TenNhom" HeaderStyle-Width="220px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-CssClass="text-right" 
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "RepairRequestDetail.aspx";
        }
