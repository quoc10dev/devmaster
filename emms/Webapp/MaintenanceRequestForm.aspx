<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MaintenanceRequestForm.aspx.cs" Inherits="MaintenanceRequestForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        <div class="card-text">
                            <h3 class="card-title">Maintenance request form</h3>
                        </div>
                        <div class="action">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TenLoai" HeaderStyle-Width="150px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Mẫu in thuộc loại xe</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("TenLoai") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-CssClass="text-right" 
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfTen" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "MaintenanceRequestFormDetail.aspx";
        }
