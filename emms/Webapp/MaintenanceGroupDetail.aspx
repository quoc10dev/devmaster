<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MaintenanceGroupDetail.aspx.cs" Inherits="MaintenanceGroupDetail" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="card-header">
                        ...
                        <div class="action">
                            <button type="button" class="btn btn-light" onclick="ReturnPageList()">
                                <i class="material-icons">list</i> Maintenance item group list</button>
                        </div>
                        <div class="card-body" id="formatControl" runat="server">
                            <dl class="datalist">
                                <dt>Maintenance group name <span style="color: red">(*)</span></dt>
                                <dd>
                                    <asp:TextBox ID="txtMaintenanceGroupName" runat="server" CssClass="form-input large w-75" />
                                </dd>
                                <dt>English name</dt>
                                <dd>
                                    <asp:TextBox ID="txtEnglishName" runat="server" CssClass="form-input large w-75" />
                                </dd>
                                 <dt>Parent group name</dt>
                                <dd>
                                    <div class="w-75">
                                        <asp:DropDownList ID="dlParentGroup" runat="server" CssClass="form-input select2" />
                                    </div>
                                </dd>
            ...
            <script type="text/javascript">
                function ReturnPageList() {
                    location.href = "MaintenanceGroup.aspx";
                }
            </script>
        </ContentTemplate>
    </asp:UpdatePanel>
