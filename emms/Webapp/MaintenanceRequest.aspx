<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MaintenanceRequest.aspx.cs" Inherits="MaintenanceRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="card-header">
                        ...
                        <div class="filter">
                            <div class="form-inline" id="divFilter" runat="server">
                                ...
                                <div class="filter-item">
                                    Mã thẻ
                                    <asp:TextBox ID="txtFilterMaThe" runat="server" CssClass="form-input" />
                                </div>
                                <div class="filter-item">
                                    Biển số
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TenNhom" HeaderStyle-Width="170px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField SortExpression="TenTrangThietBi" HeaderStyle-Width="150px" HeaderStyle-CssClass="col"
                                 ...
                                 <asp:TemplateField SortExpression="BienSo" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                  ...
                                  <asp:TemplateField SortExpression="CapBaoDuong" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                    <HeaderTemplate>Cấp bão dưỡng</HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("CapBaoDuong") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField SortExpression="TrangThaiKhaiThac" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                ...
                                <asp:TemplateField HeaderStyle-Width="70px" HeaderStyle-CssClass="text-right" 
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfMaThe" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "MaintenanceRequestDetail.aspx";
        }
