...
public partial class FrequencyWorking : BaseAdminGridPage
{
    #region begin
    ...
    {
        btnAddNew.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.FrequencyWorking_Add); //Phân quyền thêm
    }
    ...
    public override void BindData()
    {
        ...
        DataTable dt = FrequencyWorkingEquiment.SearchFrequency(idNhomTrangThietBi, idLoaiTrangThietBi, txtFilterBienSo.Text.Trim(),
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (row != null)
                {
                    Label lblSoLuongTanSuat = e.Row.FindControl("lblSoLuongTanSuat") as Label;
                    if (lblSoLuongTanSuat != null)
                    {
                        if (row["DonViGhiNhanHoatDong"].ToString().Equals(DonViGhiNhanHoatDong.Gio))
                            lblSoLuongTanSuat.Text = string.Format("{0} giờ/ngày",NumberHelper.ToStringNumber(row["SoLuongTanSuat"]));
                        else if (row["DonViGhiNhanHoatDong"].ToString().Equals(DonViGhiNhanHoatDong.Km))
                            lblSoLuongTanSuat.Text = string.Format("{0} km/ngày", NumberHelper.ToStringNumber(row["SoLuongTanSuat"]));
                    }
                    ...
                    if (lnkEdit != null)
                    {
                        ...
                        lnkEdit.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.FrequencyWorking_Edit); //phân quyền sửa
                    }
                    ...
                    if (lnkDelete != null)
                    {
                        ...
                        lnkDelete.Visible = FunctionManager.CheckUserHasRight(CurrentUserRight, RightCode.FrequencyWorking_Delete); //phân quyền xóa
                    }
                    ...
                    if (hfName != null && row["TrangThietBi"] != DBNull.Value)
                        hfName.Value = row["TrangThietBi"].ToString();
                }
            }
        }
        catch (Exception exc)
    ...
    protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                Response.Redirect(string.Format("FrequencyWorkingDetail.aspx?ID={0}", id));
            }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            FrequencyWorkingEquiment.DeleteFrequency(id);
            HideModal();
            BindData();
        }
        catch (Exception exc)
