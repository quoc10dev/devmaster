<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FuleProcessing.aspx.cs" Inherits="FuleProcessing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card-header">
                        ...
                        <div class="filter">
                            <div class="form-inline" id="formatControl" runat="server">   
                        ...
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="NgayHoatDong" HeaderStyle-Width="100px" HeaderStyle-CssClass="col"
                                    ...
                                    <ItemTemplate>
                                        <%# string.Format("{0:dd/MM/yyyy}",Eval("NgayNap")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField SortExpression="SoLuong" HeaderStyle-Width="100px" HeaderStyle-CssClass=""
                                    HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"  ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>Số lượng nạp (lít)</HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSoLuong" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <script type="text/javascript">
        function OpenPageDetail() {
            location.href = "FuleProcessingDetail.aspx";
        }
