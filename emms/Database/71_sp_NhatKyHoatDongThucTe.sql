...
*/
GO
ALTER PROCEDURE sp_NhatKyHoatDongThucTe (
...
BEGIN
	...
	select  IDTrangThietBi, NgayHoatDong as Ngay, Sum(SoLuong) as SoKm_SoGio
	...
	FROM #tmpResult a INNER JOIN #tmpNhatKyHoatDongThucTe b ON a.IDTrangThietBi = b.IDTrangThietBi and a.Ngay = b.Ngay
...
GO
EXEC sp_NhatKyHoatDongThucTe '20190301', '20190331', null, null, null, ''